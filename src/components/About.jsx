...
const About = () => {
    ...
    const traits = [{animation: "fade-right" ,title: "Frontend Development",description: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.",icon: <i className="fa fa-code iron-color"></i>},{animation: "fade-up" ,title: "Backend Development",description: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.",icon: <i className="fas fa-server"></i>},{animation: "fade-left" , title: "UI Design",description: "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.",icon:  <i className="fas fa-pencil-ruler"></i>}]
